...
_CELLCOLORBYFEATURESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='binaryCol', full_name='scope.CellColorByFeaturesRequest.binaryCol', index=6,
