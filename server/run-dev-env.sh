...
poetry run scope-console add-identity-provider --issuer "http://localhost:8080/auth/realms/SCope" --clientid "scope" --secret "4e979b39-9386-45a3-b3f8-e47461b03e3e" --name "Keycloak (Dev only)" --icon "https://design.jboss.org/keycloak/logo/images/keycloak_icon_256px.png"
