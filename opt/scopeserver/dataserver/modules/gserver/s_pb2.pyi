...
class FeatureRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"filter",b"filter",u"loomFilePath",b"loomFilePath",u"query",b"query"]) -> None: ...
...
class FeatureReply(google___protobuf___message___Message):
    ...
    class Feature(google___protobuf___message___Message):
        ...
        class Match(google___protobuf___message___Message):
            ...
            def ClearField(self, field_name: typing_extensions___Literal[u"description",b"description",u"title",b"title"]) -> None: ...
        type___Match = Match

        category: typing___Text = ...

        @property
        def results(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___FeatureReply.Feature.Match]: ...
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"category",b"category",u"results",b"results"]) -> None: ...
    type___Feature = Feature


    @property
    def features(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___FeatureReply.Feature]: ...
