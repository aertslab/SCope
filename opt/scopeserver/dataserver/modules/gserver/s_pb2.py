...
_GPROFILERLINKOUTREQUEST = _descriptor.Descriptor(
  name='GProfilerLinkOutRequest',
  full_name='scope.GProfilerLinkOutRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='loomFilePath', full_name='scope.GProfilerLinkOutRequest.loomFilePath', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='clusteringID', full_name='scope.GProfilerLinkOutRequest.clusteringID', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='clusterID', full_name='scope.GProfilerLinkOutRequest.clusterID', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='topNumFeatures', full_name='scope.GProfilerLinkOutRequest.topNumFeatures', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='organism', full_name='scope.GProfilerLinkOutRequest.organism', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GPROFILERLINKOUTREPLY = _descriptor.Descriptor(
  name='GProfilerLinkOutReply',
  full_name='scope.GProfilerLinkOutReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='scope.GProfilerLinkOutReply.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='scope.GProfilerLinkOutReply.error', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GPROFILERLINKOUTREPLY.fields_by_name['error'].message_type = _ERRORREPLY
...
DESCRIPTOR.message_types_by_name['GProfilerLinkOutRequest'] = _GPROFILERLINKOUTREQUEST
DESCRIPTOR.message_types_by_name['GProfilerLinkOutReply'] = _GPROFILERLINKOUTREPLY
...
GProfilerLinkOutRequest = _reflection.GeneratedProtocolMessageType('GProfilerLinkOutRequest', (_message.Message,), {
  'DESCRIPTOR' : _GPROFILERLINKOUTREQUEST,
  '__module__' : 's_pb2'
  # @@protoc_insertion_point(class_scope:scope.GProfilerLinkOutRequest)
  })
_sym_db.RegisterMessage(GProfilerLinkOutRequest)

GProfilerLinkOutReply = _reflection.GeneratedProtocolMessageType('GProfilerLinkOutReply', (_message.Message,), {
  'DESCRIPTOR' : _GPROFILERLINKOUTREPLY,
  '__module__' : 's_pb2'
  # @@protoc_insertion_point(class_scope:scope.GProfilerLinkOutReply)
  })
_sym_db.RegisterMessage(GProfilerLinkOutReply)
...
_MAIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getGProfilerLink',
    full_name='scope.Main.getGProfilerLink',
    index=26,
    containing_service=None,
    input_type=_GPROFILERLINKOUTREQUEST,
    output_type=_GPROFILERLINKOUTREPLY,
    serialized_options=None,
  ),
])
