...
_GETORCIDIDREQUEST = _descriptor.Descriptor(
  name='getORCIDiDRequest',
  full_name='scope.getORCIDiDRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='scope.getORCIDiDRequest.code', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETORCIDIDREPLY = _descriptor.Descriptor(
  name='getORCIDiDReply',
  full_name='scope.getORCIDiDReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='orcid_scope_uuid', full_name='scope.getORCIDiDReply.orcid_scope_uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='scope.getORCIDiDReply.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orcid_id', full_name='scope.getORCIDiDReply.orcid_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='success', full_name='scope.getORCIDiDReply.success', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ORCIDINFO = _descriptor.Descriptor(
  name='orcidInfo',
  full_name='scope.orcidInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='orcidName', full_name='scope.orcidInfo.orcidName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orcidID', full_name='scope.orcidInfo.orcidID', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orcidUUID', full_name='scope.orcidInfo.orcidUUID', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SETCOLABANNOTATIONDATAREQUEST.fields_by_name['orcidInfo'].message_type = _ORCIDINFO
_SETCOLABANNOTATIONDATAREQUEST.fields_by_name['annoData'].message_type = _COLLABANNODATA
_VOTEANNOTATIONREQUEST.fields_by_name['orcidInfo'].message_type = _ORCIDINFO
...
DESCRIPTOR.message_types_by_name['getORCIDiDRequest'] = _GETORCIDIDREQUEST
DESCRIPTOR.message_types_by_name['getORCIDiDReply'] = _GETORCIDIDREPLY
...
DESCRIPTOR.message_types_by_name['orcidInfo'] = _ORCIDINFO
...
CollabAnnoData = _reflection.GeneratedProtocolMessageType('CollabAnnoData', (_message.Message,), dict(
...
RegulonGenesMetric = _reflection.GeneratedProtocolMessageType('RegulonGenesMetric', (_message.Message,), dict(
...
SetAnnotationNameRequest = _reflection.GeneratedProtocolMessageType('SetAnnotationNameRequest', (_message.Message,), dict(
...
SetAnnotationNameReply = _reflection.GeneratedProtocolMessageType('SetAnnotationNameReply', (_message.Message,), dict(
...
SetLoomHierarchyRequest = _reflection.GeneratedProtocolMessageType('SetLoomHierarchyRequest', (_message.Message,), dict(
...
SetLoomHierarchyReply = _reflection.GeneratedProtocolMessageType('SetLoomHierarchyReply', (_message.Message,), dict(
...
getORCIDiDRequest = _reflection.GeneratedProtocolMessageType('getORCIDiDRequest', (_message.Message,), dict(
  DESCRIPTOR = _GETORCIDIDREQUEST,
  __module__ = 's_pb2'
  # @@protoc_insertion_point(class_scope:scope.getORCIDiDRequest)
  ))
_sym_db.RegisterMessage(getORCIDiDRequest)

getORCIDiDReply = _reflection.GeneratedProtocolMessageType('getORCIDiDReply', (_message.Message,), dict(
  DESCRIPTOR = _GETORCIDIDREPLY,
  __module__ = 's_pb2'
  # @@protoc_insertion_point(class_scope:scope.getORCIDiDReply)
  ))
_sym_db.RegisterMessage(getORCIDiDReply)

getORCIDStatusRequest = _reflection.GeneratedProtocolMessageType('getORCIDStatusRequest', (_message.Message,), dict(
...
getORCIDStatusReply = _reflection.GeneratedProtocolMessageType('getORCIDStatusReply', (_message.Message,), dict(
...
setColabAnnotationDataRequest = _reflection.GeneratedProtocolMessageType('setColabAnnotationDataRequest', (_message.Message,), dict(
...
setColabAnnotationDataReply = _reflection.GeneratedProtocolMessageType('setColabAnnotationDataReply', (_message.Message,), dict(
...
orcidInfo = _reflection.GeneratedProtocolMessageType('orcidInfo', (_message.Message,), dict(
  DESCRIPTOR = _ORCIDINFO,
  __module__ = 's_pb2'
  # @@protoc_insertion_point(class_scope:scope.orcidInfo)
  ))
_sym_db.RegisterMessage(orcidInfo)

voteAnnotationRequest = _reflection.GeneratedProtocolMessageType('voteAnnotationRequest', (_message.Message,), dict(
...
voteAnnotationReply = _reflection.GeneratedProtocolMessageType('voteAnnotationReply', (_message.Message,), dict(
...
getNextClusterRequest = _reflection.GeneratedProtocolMessageType('getNextClusterRequest', (_message.Message,), dict(
...
_MAIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getORCIDiD',
    full_name='scope.Main.getORCIDiD',
    index=20,
    containing_service=None,
    input_type=_GETORCIDIDREQUEST,
    output_type=_GETORCIDIDREPLY,
    options=None,
  ),
  _descriptor.MethodDescriptor(
    name='getORCIDStatus',
