...
_CLUSTERING = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="clusterColors",
            full_name="scope.Clustering.clusterColors",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
