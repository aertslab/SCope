...
_GETORCIDIDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='auth_code', full_name='scope.getORCIDiDRequest.auth_code', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
getORCIDiDRequest = _reflection.GeneratedProtocolMessageType('getORCIDiDRequest', (_message.Message,), {
...
getORCIDiDReply = _reflection.GeneratedProtocolMessageType('getORCIDiDReply', (_message.Message,), {
...
orcidInfo = _reflection.GeneratedProtocolMessageType('orcidInfo', (_message.Message,), {
