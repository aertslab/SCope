...
from scopeserver.api import SCopeAPI
from scopeserver.api import scope_api_model
...
@scope_api.get("/session/uuid/", response_model=scope_api_model.GetUUID)
def get_uuid(ip: str):
...
@scope_api.get("/session/{session_id}/info/", response_model=scope_api_model.GetRemainingUUIDTime)
...
@scope_api.get("/session/{session_id}/datasets/", response_model=scope_api_model.GetDatasets)
