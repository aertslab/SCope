...
const targetBehaviour = {
	drop(props, monitor, component) {
		...
		let dropped = props.onDrop(item, props.viewerName, props.orientation, props.position);
...
class AnnotationDropContainer extends Component {
	...
	render() {
		const { isOver, canDrop, connectDropTarget, height, activeAnnotations, viewerName, orientation } = this.props;
	...
	handleRemove(viewerName, name, value) {
		this.props.onRemove(viewerName, name, value, this.props.orientation, this.props.position);
	}
}
