                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Whole Adult Brain - Unfiltered Dataset -
                                        157k Cells
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        Adult Central Brain - Filtered Dataset -
                                        10k Cells
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <b>
                                    Classifying Drosophila Olfactory Projection
                                    Neuron Subtypes by Single-Cell RNA
                                    Sequencing
                                </b>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        Neurons - Filtered Dataset - 500 Cells
                                    </li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        Somatosensory cortex and hippocampal CA1
                                        regions. - Filtered Dataset - 3k Cells
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <b>
                                    ...
                                    transcriptional and epigenetic states in the
                                    human adult brain
                                </b>
                                , Lake <i>et al.</i>, 2018 (
                                <a
                                ...
                                <ul>
                                    <li>
                                        Adult visual cortex, frontal cortex, and
                                        cerebellum - Filtered Dataset - 60k
                                        Cells
                                    </li>
                                </ul>
                            </li>
