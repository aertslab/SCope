  ...
  render() {
    ...
    let limitReachedDimmer = (
      <Dimmer active={!loading && sessionsLimitReached}>
        ...
        <br />
        <Header as='h2' inverted>
          Currenlty Scope has reached it's capacity in number of concurrent
          users.
          <br />
          <br />
          ...
          <Route
            ...
            render={({ history }) => (
              <Segment className='parentView'>
                ...
                <Sidebar.Pushable>
                  ...
                  <Sidebar.Pusher style={{ width: pusherWidth }}>
                    ...
                    <Route
                      ...
                      component={() => <Compare metadata={metadata} />}
                    />
                ...
                <Dimmer
                  active={
                    !loading && this.timeout != null && this.timeout <= 0
                  }>
                  <br />
                  <br />
                  <Icon name='warning circle' color='orange' size='big' />
            ...
            if (!this.timer) {
              this.timer = setInterval(() => {
                ...
                if (this.timeout < 0) {
                  ...
                  if (DEBUG)
                    console.log('Session socket ping @ ', this.timeout);
