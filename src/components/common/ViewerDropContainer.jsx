      ...
      if (
        ...
        return (
          <div className='fullDropContainer dropContainer'>
            <p>
              <b>Drag and drop here the annotations you want to compare.</b>
              <br />
              <br />
              ...
              <br />
              <br />
              Change the number of the containers, their configuration
              <br />
              and superposition properties in the upper left corner of the page
              <br />
            </p>
          </div>
        );
        ...
        return (
          <div className='emptyDropContainer dropContainer'>
            <p>
              <b>Choose the annotation from the menu on the right</b>
              <br />
              <br />
              Select more annotations to view how the annotation changes in the
              selected dataset.
              <br />
              <br />
              Change the number of the containers, their configuration
