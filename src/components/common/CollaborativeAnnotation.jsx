        ...
        (response) => {
          ...
          if (
            ...
            BackendAPI.getNextCluster(
              ...
              this.state.submitAction == 'submitNext' ? 'next' : 'previous',
              (response) => {
      ...
      const panes = [
        {
          ...
          render: () => (
            <Tab.Pane>
              ...
              <Grid.Row>
                OLS Powered by{' '}
                <a href='https://www.ebi.ac.uk/ols/index' target='_blank'>
                  EBI OLS
                </a>
              </Grid.Row>
            </Tab.Pane>
      ...
      return (
        <React.Fragment>
                ...
                <Card style={cardStyle}>
                  <CardContent>
                    <Form.Field>
                      ...
                      List of namespaced markers. Use identifiers.org standards
                      for resolving (But we need FlyBase !
                      https://registry.identifiers.org/prefixregistrationrequest).
                      {/* <input placeholder="Search for genes..." /> */}
                      <CollabAnnoGeneSearch
                        ref={this.AnnoGeneSearch}></CollabAnnoGeneSearch>
                    </Form.Field>
                    ...
                    <Form.Field>
                      ...
                      Used to document how the mapping was made and to detail
                      any uncertainty.
                      <Form.Input
                        name='comment'
          ...
          <Modal
            ...
            <Modal.Content>
              <p>
                You MUST either select a term from the OLS search OR submit a
                manual annotation!
              </p>
            </Modal.Content>
            <Modal.Actions>
    ...
    if (
      ...
      return (
        <Popup
          ...
          content={
            <b>
              You must be logged in with an ORCID ID to annotate datasets! (See
              header)
            </b>
          }
          trigger={
