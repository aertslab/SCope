                        ...
                        <ul>
                          <li>Drosophila
                            <ul>
                              ...
                              <li><b>Cellular diversity in the Drosophila midbrain revealed by single-cell transcriptomics</b>, Croset, Treiber and Waddell, 2018 (<a href='https://doi.org/10.7554/eLife.34550' target='_blank'>eLife</a>)
                                <ul>
                                  <li>Adult Central Brain - Filtered Dataset - 10k Cells</li>
                                </ul>
                              </li>
                              <li><b>Classifying Drosophila Olfactory Projection Neuron Subtypes by Single-Cell RNA Sequencing</b>, Li and Horns <i>et al.</i>, 2017 (<a href='https://doi.org/10.1016/j.cell.2017.10.019' target='_blank'>Cell</a>)
                                <ul>
                                  <li>Pupal and Adult Olfactory Projection Neurons - Filtered Dataset - 500 Cells</li>
                                </ul>
                              </li>
                              <li><b>The Drosophila embryo at single-cell transcriptome resolution</b>, Karaiskos <i>et al.</i>, 2017 (<a href='https://doi.org/10.1126/science.aan3235' target='_blank'>Science</a>)
                                <ul>
                          ...
                          <li>Mouse
                            <ul>
                              <li><b>Brain structure. Cell types in the mouse cortex and hippocampus revealed by single-cell RNA-seq</b>, Zeisel <i>et al.</i>, 2015 (<a href='http://science.sciencemag.org/content/347/6226/1138' target='_blank'>Science</a>)
                                <ul>
                                  <li>Somatosensory cortex and hippocampal CA1 regions. - Filtered Dataset - 3k Cells</li>
                                </ul>
                              </li>
                              <li><b>Single-Cell RNA-Seq Reveals Hypothalamic Cell Diversity</b>, Chen, Wu, Jiang and Zhang, 2017 (<a href='https://doi.org/10.1016/j.celrep.2017.03.004' target='_blank'>Cell Reports</a>)
                                <ul>
                          ...
                          <li>Human
                            <ul>
                              <li><b>Integrative single-cell analysis of transcriptional and epigenetic states in the human adult brain</b>, Lake <i>et al.</i>, 2018 (<a href='http://doi.org/10.1038/nbt.4038' target='_blank'>Nature Biotechnology</a>)
                                <ul>
                                  <li>Adult visual cortex, frontal cortex, and cerebellum - Filtered Dataset - 60k Cells</li>
                                </ul>
                              </li>
                            </ul>
                          </li>
