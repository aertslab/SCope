      ...
      <Grid>
        <Grid.Row>
          <Grid.Column>
            ...
            The original version of SCope was designed and developed by Maxime
            De Waegeneer. The current version was made as a joint effort of{' '}
            ...
            and the{' '}
            <a href='https://www.bits.vib.be'>VIB Bioinformatics Core</a>.<br />
            ...
            <br />
            This software makes use of open source packages (i.e.{' '}
            <a href='https://www.npmjs.com/package/caniuse-db'>caniuse-db</a>)
            and standards (i.e.{' '}
            <a href='https://www.npmjs.com/package/spdx-expression-parse'>
              SPDX
            </a>
            ).
            <br />
            Datasets present in this tool were made using{' '}
            <a href='https://aertslab.org/#scenic'>SCENIC workflow</a>.<br />
            ...
            <a href='http://kuleuven.be'>
              <Image src='src/images/vib.png' height='50' centered flex />
            </a>
            <br />
            <br />
            <a href='http://vib.be'>
              <Image src='src/images/kuleuven.png' height='50' centered flex />
            </a>
            <br />
            <br />
